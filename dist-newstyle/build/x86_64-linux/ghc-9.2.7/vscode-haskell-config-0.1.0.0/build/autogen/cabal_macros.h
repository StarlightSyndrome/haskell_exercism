...
/* package vscode-haskell-config-0.1.0.0 */
#ifndef VERSION_vscode_haskell_config
#define VERSION_vscode_haskell_config "0.1.0.0"
#endif /* VERSION_vscode_haskell_config */
#ifndef MIN_VERSION_vscode_haskell_config
#define MIN_VERSION_vscode_haskell_config(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_vscode_haskell_config */
...
#define CURRENT_PACKAGE_KEY "vscode-haskell-config-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "vscode-haskell-config-0.1.0.0-inplace"
